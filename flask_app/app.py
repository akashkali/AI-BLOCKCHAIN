...
# Using threading mode - no async worker needed, compatible with all Python versions
socketio = SocketIO(
    app, 
    cors_allowed_origins=allowed_origins,
    async_mode='threading'  # Works with all Python versions, no special worker needed
)
